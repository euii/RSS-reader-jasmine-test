    ...
    */
        ...
        */
        ...
        it('feeds have name',function(){
            allFeeds.forEach(function(val){
                ...
                expect(val.name.length).toBeGreaterThan("");
            });
        });
    });
    ...
    describe('The menu',function(){
        ...
        it('toggle menu',function(){
            expect(getComputedStyle(sildermenu).transform).toBe("matrix(1, 0, 0, 1, -192, 0)");
            menu_icon.click();
            setTimeout(function(){
                expect(getComputedStyle(sildermenu).transform).toBe("matrix(1, 0, 0, 1, 0, 0)");
            },1000);
